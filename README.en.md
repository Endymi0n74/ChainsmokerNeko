...
The current stable release is **2.0.2** — 10 bundles, 3 OS (direct links):

| Platform | File |
|---|---|
| Windows x64 (portable) | [hakuneko-electron-v2.0.2-win32-x64.zip](https://github.com/Endymi0n74/ChainsmokerNeko/releases/download/2.0.2/hakuneko-electron-v2.0.2-win32-x64.zip) |
| Windows x64 (installer) | [hakuneko-electron-v2.0.2-win32-x64-setup.exe](https://github.com/Endymi0n74/ChainsmokerNeko/releases/download/2.0.2/hakuneko-electron-v2.0.2-win32-x64-setup.exe) |
| Windows ia32 (portable) | [hakuneko-electron-v2.0.2-win32-ia32.zip](https://github.com/Endymi0n74/ChainsmokerNeko/releases/download/2.0.2/hakuneko-electron-v2.0.2-win32-ia32.zip) |
| Windows ia32 (installer) | [hakuneko-electron-v2.0.2-win32-ia32-setup.exe](https://github.com/Endymi0n74/ChainsmokerNeko/releases/download/2.0.2/hakuneko-electron-v2.0.2-win32-ia32-setup.exe) |
...
| Windows ARM (installer) | [hakuneko-electron-v2.0.2-win32-arm64-setup.exe](https://github.com/Endymi0n74/ChainsmokerNeko/releases/download/2.0.2/hakuneko-electron-v2.0.2-win32-arm64-setup.exe) |
