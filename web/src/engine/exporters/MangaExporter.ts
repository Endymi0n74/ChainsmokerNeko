...
export abstract class MangaExporter {
    ...
    public abstract Export(sourceFileList: Map<number, string>, targetDirectory: FileSystemDirectoryHandle, chapterTitle: string, mangaTitle?: string, options?: JSONObject): Promise<void>;
}