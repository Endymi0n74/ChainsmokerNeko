...
export enum EngineResourceKey {
    ...
    Settings_Global_PDFTheme = 'Settings_Global_PDFTheme',
    Settings_Global_PDFThemeInfo = 'Settings_Global_PDFThemeInfo',
    Settings_Global_PDFTheme_White = 'Settings_Global_PDFTheme_White',
    Settings_Global_PDFTheme_Sepia = 'Settings_Global_PDFTheme_Sepia',
    Settings_Global_PDFTheme_Dark = 'Settings_Global_PDFTheme_Dark',
    Settings_Global_PDFDoublePage = 'Settings_Global_PDFDoublePage',
    Settings_Global_PDFDoublePageInfo = 'Settings_Global_PDFDoublePageInfo',
