...
const translations: VariantResource = { // NOTE: Use defaults for missing translations
  ...
  Frontend_Help: "Tulong",
  Frontend_About: "Tungkol Dito",
  ...
  Frontend_Item: 'Item',
  Frontend_Items: "mga gamit",
  Frontend_Item_List: 'Item list',
  Frontend_Item_Select: "Pumili ng aytem",
  Frontend_Item_Selection: 'Item selection',
  // [SECTION]: Frontend Classic
  Frontend_Classic_Label: "Klasiko",
  ...
  Frontend_Classic_Sidenav_Home: "Tahanan",
  ...
  Frontend_FluentCore_Settings_ShowDownloadsPanel_Label: "Kompayahin ang tagapamahala",
  ...
  Frontend_FluentCore_SettingsDialog_CloseButton_Label: "Ipasa",
  //
  Frontend_FluentCore_BookmarkList_Heading: 'Bookmarks',
  //
  Frontend_FluentCore_DownloadManager_Heading: 'Downloads',
  Frontend_FluentCore_DownloadManagerTask_StatusQueued_Description: "Nakapila",
  Frontend_FluentCore_DownloadManagerTask_StatusPaused_Description: "I-hinto",
  Frontend_FluentCore_DownloadManagerTask_StatusDownloading_Description: "I-diskarga",
  Frontend_FluentCore_DownloadManagerTask_StatusProcessing_Description: "Pinoproseso",
  Frontend_FluentCore_DownloadManagerTask_StatusFailed_Description: "Nabigo",
  Frontend_FluentCore_DownloadManagerTask_StatusCompleted_Description: "Tapos Na",
  ...
  Settings_Global_Language: "Mga Wika",
  ...
  Settings_Global_UserAgent: "Ahente ng User",
  ...
  //
  Settings_FeatureFlags_Label: "Mga Tampok na Bandila",
  ...
  Settings_FeatureFlags_ShowSplashScreen_Label: "Ipakita ang i-splash sa screen",
  ...
  Tags_Source: "Pinagmulan",
  Tags_Source_Official: 'Official',
  Tags_Source_Scanlator: 'Scanlator',
  Tags_Source_Aggregator: "Pagsama-sama",
  Tags_Accessibility: "Aksibilidad",
  ...
  Tags_Others: "Iba Pa",
  // [SECTION]: Annotations
  Annotations_ViewProgress: "Pagsulong",
  ...
  // [SECTION]: Trackers
  Tracker_Kitsu_Settings_Username: "Pangalan",
  ...
  Plugin_SheepScanlations_Settings_Username: "Pangalan",
