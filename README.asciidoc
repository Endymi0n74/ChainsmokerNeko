...
image:https://github.com/Endymi0n74/ChainsmokerNeko/actions/workflows/push-ci.yml/badge.svg[link=https://github.com/Endymi0n74/ChainsmokerNeko/actions/workflows/push-ci.yml, title="Push (CI)", window="_blank"]
